...
const SELECT_COLS =
  "id, email, created_at, source, notes, budget_range, purpose, area, comment, property_type, status, manual_notes, classification";
...
function rowToLead(row) {
  ...
  return {
    ...
    classification: s(row.classification), // "A" | "B" | "C" | ""
    classification_editable: true, // subscribers table has a classification column
...
const WRITE_MAP = {
  ...
  classification: "classification", // "A" | "B" | "C" | "" (cleared)
};
