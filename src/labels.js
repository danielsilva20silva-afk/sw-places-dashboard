...
const DEFAULTS = {
  ...
  na_title: "Próxima ação",
  na_none: "Sem próxima ação — adicionar uma?",
  na_add: "+ Nova ação",
  na_field_title: "Título",
  na_title_ph: "ex. Ligar de volta, enviar imóveis",
  na_field_desc: "Descrição (opcional)",
  na_field_date: "Data",
  na_field_time: "Hora",
  na_create: "Adicionar ação",
  na_creating: "A adicionar…",
  na_save: "Guardar",
  na_cancel: "Cancelar",
  na_edit: "Editar",
  na_delete: "Eliminar",
  na_delete_confirm: "Eliminar esta ação?",
  na_complete: "Concluir",
  na_overdue: "Em atraso",
  na_today: "Hoje",
  na_card_title: "Ações",
  ...
  // ── WhatsApp templates manager (templates feature) ──
  tpl_title: "Mensagens WhatsApp",
  tpl_subtitle: "Os textos que o notificador de leads envia por campanha. Um é escolhido ao acaso (anti-spam).",
  tpl_loading: "A carregar mensagens…",
  tpl_load_failed: "Não foi possível carregar as mensagens.",
  tpl_empty: "Ainda não há mensagens.",
  tpl_audience_specific_area: "Área específica",
  tpl_audience_open: "Aberto a todas",
  tpl_default_group: "Padrão (fallback)",
  tpl_default_hint: "Usado quando nenhuma campanha corresponde.",
  tpl_active: "Ativa",
  tpl_inactive: "Inativa",
  tpl_save: "Guardar",
  tpl_saving: "A guardar…",
  tpl_saved: "Guardado ✓",
  tpl_save_failed: "Não foi possível guardar.",
  tpl_delete: "Eliminar",
  tpl_delete_confirm: "Eliminar esta mensagem?",
  tpl_delete_failed: "Não foi possível eliminar.",
  tpl_sort: "Ordem",
  tpl_body_label: "Texto da mensagem",
  tpl_add_variant: "+ Adicionar variante",
  tpl_add_group: "+ Adicionar campanha",
  tpl_new_group_key_ph: "ex. vale formoso",
  tpl_new_group_help: "Tem de aparecer no nome da campanha (sem distinção de maiúsculas), ex. vale formoso",
  tpl_new_group_create: "Criar grupo",
  tpl_new_group_cancel: "Cancelar",
  tpl_empty_body: "O texto não pode ficar vazio.",
  tpl_warn_area: "Este texto de “área específica” não tem o marcador {area}.",
  tpl_placeholders_title: "Marcadores",
  tpl_ph_greeting: "{greeting} → rotativo a partir da tua lista de saudações (editável aqui)",
  tpl_greetings_title: "Saudações",
  tpl_greetings_hint: "Escolhidas ao acaso para o {greeting}.",
  ...
  tpl_preview: "Pré-visualização",
  tpl_matches: "Corresponde a uma campanha ativa",
  tpl_no_match: "Nenhuma campanha ativa corresponde a esta chave",
  tpl_unmatched_title: "Campanhas a usar as mensagens padrão",
  tpl_unmatched_hint: "Estas campanhas ativas não correspondem a nenhum grupo acima.",
  tpl_create_group_for: "Criar grupo",
  tpl_sample_greeting: "Olá",
  tpl_sample_name: "João",
  tpl_sample_area: "Quinta do Lago",
