...
export default {
  ...
  labels: {
    ...
    export_all_title: "Export all leads to CSV",
    export_filtered_title: "Export the filtered leads to CSV",
    // CSV column headers
    csv_col_name: "Name",
    csv_col_email: "Email",
    csv_col_phone: "Phone",
    csv_col_campaign: "Source / campaign",
    csv_col_sources: "All sources",
    csv_col_classification: "Classification",
    csv_col_status: "Status",
    csv_col_created: "Created at",
    csv_col_budget: "Budget",
    csv_col_intent: "Intent",
    csv_col_area: "Area",
    csv_col_notes: "Summary",
    csv_col_manual_notes: "Notes",
    csv_col_source_content: "Source content",
    csv_col_source_url: "Source link",
    ...
    tpl_title: "WhatsApp messages",
    tpl_subtitle: "The texts the lead notifier sends per campaign. One is picked at random (anti-spam).",
    tpl_loading: "Loading messages…",
    tpl_load_failed: "Couldn't load messages.",
    tpl_empty: "No messages yet.",
    tpl_audience_specific_area: "Specific area",
    tpl_audience_open: "Open to all",
    tpl_default_group: "Default (fallback)",
    tpl_default_hint: "Used when no campaign matches.",
    tpl_active: "Active",
    tpl_inactive: "Inactive",
    tpl_save: "Save",
    tpl_saving: "Saving…",
    tpl_saved: "Saved ✓",
    tpl_save_failed: "Couldn't save.",
    tpl_delete: "Delete",
    tpl_delete_confirm: "Delete this message?",
    tpl_delete_failed: "Couldn't delete.",
    tpl_sort: "Order",
    tpl_body_label: "Message text",
    tpl_add_variant: "+ Add variant",
    tpl_add_group: "+ Add campaign group",
    tpl_new_group_key_ph: "e.g. vale formoso",
    tpl_new_group_help: "Must appear in the campaign name (case-insensitive), e.g. vale formoso",
    tpl_new_group_create: "Create group",
    tpl_new_group_cancel: "Cancel",
    tpl_empty_body: "Text can't be empty.",
    tpl_warn_area: "This “specific area” text has no {area} placeholder.",
    tpl_placeholders_title: "Placeholders",
    tpl_ph_greeting: "{greeting} → rotated from your greetings list (editable here)",
    tpl_greetings_title: "Greetings",
    tpl_greetings_hint: "Picked at random for {greeting}.",
    ...
    tpl_preview: "Preview",
    tpl_matches: "Matches a live campaign",
    tpl_no_match: "No live campaign matches this key",
    tpl_unmatched_title: "Campaigns using the default templates",
    tpl_unmatched_hint: "These live campaigns don't match any group above.",
    tpl_create_group_for: "Create group",
    tpl_sample_greeting: "Hey",
    tpl_sample_name: "James",
